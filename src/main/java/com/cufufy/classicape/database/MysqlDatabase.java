...
public class MysqlDatabase implements Database, SyncronizableDatabase {
    ...
    public MysqlDatabase(ClassiCape instance) {
    ...
    public void initialize() {
        try {
            ...
            Bukkit.getConsoleSender().sendMessage(ChatColor.GREEN + "[ClassiCape] MySQL connected successfully !");
        } catch (Exception e) {
            Bukkit.getConsoleSender().sendMessage(ChatColor.RED + "[ClassiCape] MySQL connection failed !");
            e.printStackTrace();
        }
        startConnection();
