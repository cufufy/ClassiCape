package com.cufufy.classicape.cape;
...
import com.cufufy.classicape.utils.ProtocolVersionOffset;
import com.cufufy.classicape.utils.VersionChecker;
...
public class PlayerCape {
    ...
    private static ClassiCape instance = ClassiCape.getInstance();
    ...
    public void spawn(Player player) {
        ...
        }.runTaskTimerAsynchronously(ClassiCape.getInstance(), 0, 0);
    ...
    public void respawn(Player player, Player wearer) {
        ...
        }.runTaskLater(ClassiCape.getInstance(), 1);
    }
