package com.cufufy.classicape.inventory;

import com.cufufy.classicape.cape.Cape;
import com.cufufy.classicape.cape.OwnedCape;
import com.cufufy.classicape.language.Language;
...
import com.cufufy.classicape.utils.Heads;
...
public class CapeInventory implements InventoryProvider {
    ...
    private static CapeManager capeManager = ClassiCape.getInstance().getCapeManager();
    private static LanguageManager langManager = ClassiCape.getInstance().getLanguageManager();
